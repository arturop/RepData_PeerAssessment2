...
For this preliminary study I decided to consider both Injuries and Fatalities as harm to the population. The figure below represents the top 10 atmospheric events leading to harm as defined by the previous sentence. Clearly Tornadoes are orders of magnitude more significant.
...
loss[order(-loss$ECOLOSS),]
lossTop10 <- head(loss[order(-loss$ECOLOSS),], n = 10)
dotchart(lossTop10$ECOLOSS, lossTop10$EVTYPE)
```